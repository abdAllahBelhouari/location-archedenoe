		...
		<div class="container-fluid">
			<div class="row py-4">
				<div class="col-sm-12 col-md-12 col-lg-7 col-xl-7">
					...
					<div class="text-end">
							<a href="<?= $_SERVER["PHP_SELF"];?>" class="mybtn-light">Annuler</a>
							<button type="submit" name="subFormCondition">Ajouter</button>
					</div>
													...
													<li>
														...
														href="?route=conditions&show=<?= $condition['idTerme']?>">
															<i
																...
																Rendre <?= is_null($condition['webTerme']) ? 'visible' : 'invisible' ;?></a>
													</li>
													<li>
														<a class="dropdown-item"
															href="#">
